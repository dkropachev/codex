...
- OpenAI file MCP behavior is covered: codex-rs/core/tests/suite/openai_file_mcp.rs:codex_apps_file_params_pass_uploaded_file_to_post_tool_use_hook,codex_apps_file_params_upload_environment_files_before_mcp_tool_call
