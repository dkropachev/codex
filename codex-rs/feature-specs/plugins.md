...
- Plugin request-to-install behavior is covered: codex-rs/core/tests/suite/request_plugin_install.rs:endpoint_mode_injects_candidates_hides_list_and_rejects_invented_ids,endpoint_mode_with_no_eligible_candidates_exposes_no_suggestion_tools,endpoint_recommendation_adds_install_identity_only_to_elicitation_metadata,explicit_false_preserves_legacy_workflow,remote_plugin_install_refreshes_plugin_and_apps_tool_caches
...
- Plugin list API behavior is covered part 4: codex-rs/app-server/tests/suite/v2/plugin_list.rs:plugin_list_omits_created_by_me_when_remote_plugins_disabled,plugin_list_omits_shared_with_me_kind_when_plugin_sharing_disabled,plugin_list_propagates_openai_curated_remote_collection_errors_when_remote_plugin_disabled,plugin_list_rejects_relative_cwds,plugin_list_returns_empty_when_workspace_codex_plugins_disabled,plugin_list_returns_installed_git_source_interface_from_cache
- Plugin list API behavior is covered part 5: codex-rs/app-server/tests/suite/v2/plugin_list.rs:plugin_list_returns_plugin_interface_with_absolute_asset_paths,plugin_list_returns_share_context_for_shared_local_plugin,plugin_list_reuses_cached_workspace_codex_plugins_setting,plugin_list_skips_openai_curated_remote_collection_for_api_auth_when_remote_plugin_disabled,plugin_list_skips_invalid_marketplace_file_and_reports_error,plugin_list_sync_upgrades_and_removes_remote_installed_plugin_bundles,plugin_list_uses_alternate_discoverable_manifest_and_keeps_undiscoverable_plugins
