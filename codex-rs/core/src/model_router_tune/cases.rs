...
pub(super) struct ReplayCase {
    ...
    pub(super) production_model_provider: String,
    pub(super) production_model: Option<String>,
        ...
        match item {
            ...
            RolloutItem::EventMsg(EventMsg::TurnStarted(started)) => {
                active_turn = Some(PartialTurn {
                    ...
                    production_model_provider: rollout.model_provider.clone(),
                    production_model: rollout.model.clone(),
                    prompt_bytes_hint: 0,
...
impl PartialTurn {
    fn into_case(self) -> Option<ReplayCase> {
        ...
        Some(ReplayCase {
            ...
            source: self.source,
            production_model_provider: self.production_model_provider,
