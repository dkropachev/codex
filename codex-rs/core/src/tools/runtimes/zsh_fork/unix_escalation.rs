...
fn approval_sandbox_permissions(
    ...
    let sandbox_permissions = if additional_permissions_preapproved
        && matches!(
            sandbox_permissions,
    ...
    sandbox_permissions_preserving_denied_reads(sandbox_permissions, file_system_sandbox_policy)
}
