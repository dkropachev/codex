...
pub fn filter_request_plugin_install_discoverable_tools_for_client(
    ...
    filter_tool_suggest_discoverable_tools_for_client(discoverable_tools, app_server_client_name)
}
...
pub type RequestPluginInstallEntry = ToolSuggestEntry;
...
pub fn collect_request_plugin_install_entries(
    ...
    collect_tool_suggest_entries(discoverable_tools)
}
