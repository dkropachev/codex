...
fn request_user_input_unavailable_messages_respect_default_mode_feature_flag() {
    assert_eq!(
        request_user_input_unavailable_message(ModeKind::Plan, &[ModeKind::Plan, ModeKind::Codex]),
        None
    );
    assert_eq!(
        request_user_input_unavailable_message(ModeKind::Codex, &[ModeKind::Plan, ModeKind::Codex]),
        None
    );
    assert_eq!(
        request_user_input_unavailable_message(
            ModeKind::Default,
            &[ModeKind::Plan, ModeKind::Codex]
        ),
...
fn request_user_input_tool_description_mentions_available_modes() {
    assert_eq!(
        request_user_input_tool_description(&[ModeKind::Plan, ModeKind::Codex]),
