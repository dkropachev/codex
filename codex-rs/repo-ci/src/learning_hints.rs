...
pub struct RepoCiLearningHints {
    ...
    pub workflow_history_hints: Vec<crate::WorkflowHistoryHint>,
}
...
pub fn collect_learning_hints(repo_root: &Path) -> Result<RepoCiLearningHints> {
    ...
    Ok(RepoCiLearningHints {
        ...
        workflow_history_hints: workflow_history::collect_workflow_history_hints(repo_root),
    })
}
...
"#,
        ...
        assert_eq!(hints.workflow_history_hints, Vec::new());
    }
