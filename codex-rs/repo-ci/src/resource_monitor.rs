...
mod tests {
    ...
    #[test]
    fn parse_docker_event_and_inspect_metadata() {
        let labels = BTreeMap::from([
    ...
    #[test]
    fn parse_podman_event_and_stats_metadata() {
        assert_eq!(
            parse_runtime_event(
    ...
    #[test]
    fn attribute_labeled_compose_and_created_containers() {
