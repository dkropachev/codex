...
pub(super) fn cache_project_root_lookup(chat: &mut ChatWidget, root_name: Option<&str>) {
...
pub(super) fn cache_project_root(chat: &mut ChatWidget, root_name: &str) {
    cache_project_root_lookup(chat, Some(root_name));
}
