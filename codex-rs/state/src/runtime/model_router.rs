...
mod tests {
    ...
    async fn route_max_observed_total_tokens_uses_production_and_shadow_only() {
        ...
        for (task_key, request_kind, total_tokens) in [
            ("module.review.review", RouterRequestKind::Production, 100),
            ("module.review.review", RouterRequestKind::Shadow, 250),
            ("module.review.review", RouterRequestKind::Judge, 1_000),
        ...
        assert_eq!(
            runtime
                .model_router_route_max_observed_total_tokens("module.review.review")
                .await
                .expect("max observed"),
            Some(250)
        );
        assert_eq!(
            runtime
                .model_router_route_max_observed_total_tokens("missing")
                .await
                .expect("missing max observed"),
            None
        );
    }
